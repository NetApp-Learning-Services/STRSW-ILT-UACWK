...
# do ssh root@$x "rm -rf /etc/docker/certs.d/$REGISTRY_NAME:5000;mkdir -p /etc/docker/certs.d/$REGISTRY_NAME:5000";
# done
...
$command = "rm -rf /etc/docker/certs.d/'$REGISTRY_NAME':30001;mkdir -p /etc/docker/certs.d/'$REGISTRY_NAME':30001"
$validation = "ls -ld /etc/docker/certs.d/'$REGISTRY_NAME':30001"
